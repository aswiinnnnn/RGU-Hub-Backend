...
STATICFILES_DIRS = [BASE_DIR / 'static']  # include your app-level static files if any

# WhiteNoise settings for reliable static serving
STORAGES = {
    "default": {
...
# Prevent crash if manifest is missing after collectstatic
